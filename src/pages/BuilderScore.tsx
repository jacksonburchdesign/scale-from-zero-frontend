  ...
  return (
    <div className="max-w-4xl mx-auto px-6 pt-40 pb-24 text-center">
      <div className="bg-zinc-900/30 backdrop-blur-xl border border-white/10 p-8 md:p-16 rounded-3xl">
        <div className="w-24 h-24 bg-indigo-500/20 border border-indigo-500/30 rounded-2xl mx-auto mb-8 flex items-center justify-center text-4xl font-extrabold text-indigo-400">
          98
        </div>
